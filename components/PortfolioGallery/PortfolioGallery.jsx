...
export const PortfolioGallery = ({ id }) => {
  const data = [
    { id: 1, href: `/images/galleries/${id}/0.jpg` },
    ...
    { id: 9, href: `/images/galleries/${id}/8.jpg` },
    { id: 10, href: `/images/galleries/${id}/9.jpg` },
    { id: 11, href: `/images/galleries/${id}/10.jpg` },
    { id: 12, href: `/images/galleries/${id}/11.jpg` },
  ];
